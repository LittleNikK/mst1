...
function ProofCard({ title, description, image, alt }) {
  return (
    ...
    >
      <div className="relative aspect-video shrink-0 overflow-hidden bg-[linear-gradient(135deg,rgba(255,45,45,0.16),rgba(0,0,0,0.04))]">
            ...
            <div className="relative inline-block">
              <h1 className="bungee-regular text-3xl sm:text-5xl md:text-6xl leading-tight tracking-tight text-black font-extrabold uppercase mb-5">
                <span className="block">
                  Digital Identity & <span className="text-[#ff2d2d]">KYC</span>
                </span>
              </h1>
            </div>
